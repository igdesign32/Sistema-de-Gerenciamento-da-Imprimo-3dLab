...
export function FinanceView() {
  ...
  return <div className="space-y-5">
    ...
    <Dialog open={editOpen} onOpenChange={open => { setEditOpen(open); if (!open) resetForm(); }}><DialogContent className="max-h-[92vh] overflow-y-auto border-[#124787] bg-[#124787] text-white sm:max-w-xl"><DialogHeader><DialogTitle className="flex items-center gap-2 text-white"><Pencil className="size-5 text-[#ff6b35]"/> Editar Lançamento Financeiro</DialogTitle><DialogDescription className="text-blue-100">Revise os dados da receita e salve as alterações.</DialogDescription></DialogHeader><div className="grid gap-4 sm:grid-cols-2">
